    ...
    <div className="relative min-h-screen bg-white/70 flex flex-col items-center">
      ...
      <div className="relative flex flex-col items-center w-full max-w-125 z-20 gap-20 md:w-1/2 md:m-auto">
        ...
        <div className="w-full flex flex-col items-center">
          <Image alt="Seroj & Bella" src='/img1.JPG' width={500} height={500} className="h-screen md:h-auto" />
        ...
        <div className="flex flex-col justify-center items-center gap-16 w-full p-5 md:p-0">
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <Image alt="Սուրբ Սարգիս Եկեղեցի" src='/Church.svg' width={500} height={500} />
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <Image alt="ԶԱԳՍ-ի արարողություն" src='/Florence.svg' width={500} height={500} />
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            ...
            <Image alt="Հարսանեկան խնջույք" src='/Hall.svg' width={500} height={500} />
